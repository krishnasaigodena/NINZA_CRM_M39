...
public class CreateCampaignWithExpectedCloseDate {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		//Read data from properties file
		  ...
		  "C:\\Users\\goden\\OneDrive\\Documents\\BasicSeleniumNotes\\CommnData1.properties"); 
		  Properties prop = new Properties(); prop.load(fis); String BROWSER =
		  prop.getProperty("Browser"); String URL = prop.getProperty("URL"); String
		  USERNAME = prop.getProperty("Username"); String PASSWORD =
		...
		/*
		 * Date d = new Date(); SimpleDateFormat sim = new
		 * SimpleDateFormat("dd-MM-yyyy"); sim.format(d); Calendar cal =
		 * sim.getCalendar(); cal.add(Calendar.DAY_OF_MONTH, 30); String requiredDate =
		 * sim.format(cal.getTime());
		 */
		
		JavaUtility jLib = new JavaUtility();
		String Expected_Closed_Date = jLib.togetRequiredDate(30);
			...
			//launch the browser
		        ...
		        createCampaignPage.getExpectedCloseDateTF().sendKeys(Expected_Closed_Date);
		        //driver.findElement(By.name("expectedCloseDate")).sendKeys(Expected_Closed_Date);
